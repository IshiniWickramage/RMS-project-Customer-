...
import { updateCustomer, deleteCustomer, fetchCustomer } from '../../redux/actions/customerActions';

function CustomerOverview({ customer, updateCustomer, deleteCustomer, fetchCustomer }) {
  ...
  return (
    <div className="App">
      <Header />
      <div className="parts" style={{ float: 'left', marginTop: "0px", marginLeft: '0px', marginRight: '24px' }}>
        <LeftSideNavBar />
      </div>
